provider "aws" {
  ...
  # the volume and buckets this stack creates specifically to be *untagged*. An
  # agent that flags untagged resources would then find none, and the seeded
  # mess would silently stop producing the finding it exists to produce.
  #
